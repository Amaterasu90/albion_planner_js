...
class AlbionDataApp extends React.Component {
    ...
    onArtifactSelected = (e) => {
        this.setState({ componentType: "artifact" })
    }

    onItemTypeSelected = (e) => {
        this.setState({ componentType: "itemType" })
    }

    onJournalSelected = (e) => {
        this.setState({ componentType: "journal" })
    }

    onResourceSelected = (e) => {
        this.setState({ componentType: "resource" })
    }
    ...
    render() {
        ...
        return <Container fluid>
            <Row className="flex-nowrap">
                ...
                <Col md={9} xl={10}>
                    {this.componentManage(componentType)}
                </Col>
            </Row>
        </Container>
    }
