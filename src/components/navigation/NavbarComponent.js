    ...
    render() {
        return <Navbar>
            <Nav className="mb-sm-auto flex-column align-items-baseline">
                ...
                <Nav.Item>
                    <p className="nav-link text-white" style={{"cursor": "pointer"}} onClick={this.props.openItemTypesCrud}> <FontAwesomeIcon icon={faListAlt} /> <span className="d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-inline">Types</span></p>
                </Nav.Item>
                <Nav.Item>
