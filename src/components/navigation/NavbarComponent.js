        ...
        return <>
            <Navbar>
                <Nav className="mb-sm-auto flex-column align-items-baseline">
                    <Nav.Item>
                        <p className={`nav-link ${this.getColor("0", nodes, "text-success", "text-light")} fs-3`} eventKey="0" style={{ "cursor": "pointer" }} onClick={() => this.onNavigationClicked("0", this.props.openArtifactsCrud)}> <FontAwesomeIcon icon={faBookOpen} /> <span className="d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-inline">Artifacts</span></p>
                    </Nav.Item>
                    <Nav.Item>
                        <p className={`nav-link ${this.getColor("1", nodes, "text-success", "text-light")} fs-3`} eventKey="1" style={{ "cursor": "pointer" }} onClick={() => this.onNavigationClicked("1", this.props.openJournalsCrud)}> <FontAwesomeIcon icon={faBook} /> <span className="d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-inline">Journals</span></p>
                    </Nav.Item>
                    <Nav.Item>
                            ...
                            <Card className="bg-dark text-white p-0 m-0 border-0">
                                ...
                                <Accordion.Collapse eventKey="2" className="bg-dark text-white">
                                    <Card.Body className="bg-dark d-flex flex-column align-items-baseline p-0">
                                        ...
                                        <p className={`nav-link ${this.getColor("2_1", nodes, "text-success", "text-warning")} fs-3 px-0`} style={{ "cursor": "pointer" }} onClick={() => this.onNavigationClicked("2_1", this.props.openGatherResourceTypesCrud)}> <FontAwesomeIcon icon={faListAlt} /> <span className="d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-inline">Resource Types</span></p>
                                    </Card.Body>
                                </Accordion.Collapse>
                                <Card.Header className="bg-dark text-white px-0 m-0 border-0 d-flex flex-column align-items-baseline">
                                    <CustomToggle eventKey="3" nodes={this.state.nodes} className="bg-dark text-white p-0">
                                ...
                                <Accordion.Collapse eventKey="3" className="bg-dark text-white">
                                    <Card.Body className="bg-dark d-flex flex-column align-items-baseline p-0">
                                        ...
                                        <p className={`nav-link ${this.getColor("3_1", nodes, "text-success", "text-warning")} fs-3 px-0`} style={{ "cursor": "pointer" }} onClick={() => this.onNavigationClicked("3_1", this.props.openMaterialTypesCrud)}> <FontAwesomeIcon icon={faListAlt} /> <span className="d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-inline">Material Types</span></p>
                                    </Card.Body>
                                </Accordion.Collapse>
                                <Card.Header className="bg-dark text-white px-0 m-0 border-0 d-flex flex-column align-items-baseline">
                                ...
                                <Accordion.Collapse eventKey="4" className="bg-dark text-white">
                                    <Card.Body className="bg-dark d-flex flex-column align-items-baseline p-0">
                                        ...
                                        <p className={`nav-link ${this.getColor("4_1", nodes, "text-success", "text-warning")} fs-3 px-0`} style={{ "cursor": "pointer" }} onClick={() => this.onNavigationClicked("4_1", this.props.openProductTypesCrud)}> <FontAwesomeIcon icon={faListAlt} /> <span className="d-none d-sm-none d-md-none d-lg-none d-xl-none d-xxl-inline">Product Types</span></p>
                                    </Card.Body>
                                </Accordion.Collapse>
                            </Card>
                        </Accordion>
